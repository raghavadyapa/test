         ...
         try (ImageInputStream imageInputStream = ImageIO.createImageInputStream(is)) {
           ...
           IntStream.range(0, numPage).forEach(v -> {
             try {
               ...
               ImageIO.write(tiff, "png",new File("C:\\Users\\techolution\\Downloads\\Patent format\\20020101_with embedded_tiff images\\DESIGN\\USD0452600-20020101\\test\\"+name+".png") );//parentFolder + "/png/" + name + v + ".png"));
             } catch (IOException e) {
               e.printStackTrace();
             }
           });
